...
namespace Template.Persistence.Database
{
    public class MysqlDatabaseManager : IDatabaseManager
    {
        ...
        public MysqlDatabaseManager(IConfigManager configManager)
        {
            _configManager = configManager;
        }

        public MysqlDatabaseManager(string connectionName, IConfigManager configManager)
        {
        ...
        public IDbTransaction BeginTransaction(System.Data.IsolationLevel isolationLevel)
        {
            ...
            _transaction = connection.BeginTransaction(isolationLevel) as MySqlTransaction;
            return _transaction;
        }
